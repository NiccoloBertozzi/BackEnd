...
namespace API_AIBVC.Controllers
{
    ...
    public class LoginRegisterController : Controller
    {
        ...
        public ActionResult<InfoMsg> RegistraAllenatore([FromBody] AllenatoreLogin allenatoreLogin)
        {
        ...
        [ProducesResponseType(StatusCodes.Status422UnprocessableEntity)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public ActionResult<InfoMsg> RegistraAtleta([FromBody] AtletaLogin atletalogin)
        {
        ...
        [ProducesResponseType(StatusCodes.Status422UnprocessableEntity)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public ActionResult<InfoMsg> RegistraDelegato([FromBody] DelegatoLogin delegatologin)
        {
        ...
        [ProducesResponseType(StatusCodes.Status422UnprocessableEntity)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public ActionResult<InfoMsg> RegistraSocieta([FromBody] SocietaLogin societalogin)
        {
